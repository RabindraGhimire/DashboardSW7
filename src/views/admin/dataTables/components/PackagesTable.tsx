import {
  ...
  import {
	createColumnHelper, flexRender, getCoreRowModel, getSortedRowModel, SortingState, useReactTable, getPaginationRowModel
  ...
  export default function PackageTable(props: { tableData: any, onProductClick: (product: RowObj) => void }) {
	...
	return (
	  <Card flexDirection='column' w='100%' px='0px' overflowX={{ sm: 'scroll', lg: 'hidden' }}>
		...
		<Box mb="60px"> {/* Added bottom margin for more space between the table and pagination */}
